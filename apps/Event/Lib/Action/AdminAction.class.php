...
/*=================================Action区域===========================================*/
    ...
    public function event()
    {
        ...
        $this->pageKeyList = array('eid', 'name', 'time', 'location', 'enrollmentNumber', 'manNumber', 'price', 'cate', 'user', 'action');
        $this->searchKey = array('eid', 'name', 'stime', 'etime', 'uid');
        $this->searchPostUrl = U('Event/Admin/event',array('tabHash'=>'event'));
